...
#ifndef THERON_DETAIL_MESSAGECACHE_POOL_H
#define THERON_DETAIL_MESSAGECACHE_POOL_H
...
THERON_FORCEINLINE void Pool::Clear()
{
...
#endif // THERON_DETAIL_MESSAGECACHE_POOL_H
